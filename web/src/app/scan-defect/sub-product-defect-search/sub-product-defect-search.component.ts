...
@Component({
  selector: 'app-sub-product-defect-search',
  templateUrl: './sub-product-defect-search.component.html',
  styleUrls: ['./sub-product-defect-search.component.scss']
})
export class SubProductDefectSearchComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.datas = await this._defectSvc.getSubProduct(this.model);
