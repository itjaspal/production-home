...
@Component({
  selector: 'app-scan-putaway-check-qr',
  templateUrl: './scan-putaway-check-qr.component.html',
  styleUrls: ['./scan-putaway-check-qr.component.scss']
})
export class ScanPutawayCheckQrComponent implements OnInit {
