...
export class ScanPutawayDetailComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.setNolist = await this._dll.getDdlPtwSetNoList(this._actRoute.snapshot.params.ic_entity, this._actRoute.snapshot.params.doc_code, this._actRoute.snapshot.params.doc_no);
    this.prodlist  = await this._dll.getDdlPtwProdList(this._actRoute.snapshot.params.ic_entity, this._actRoute.snapshot.params.doc_code, this._actRoute.snapshot.params.doc_no);
