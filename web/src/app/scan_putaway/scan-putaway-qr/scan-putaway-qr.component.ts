...
@Component({
  selector: 'app-scan-putaway-qr',
  templateUrl: './scan-putaway-qr.component.html',
  styleUrls: ['./scan-putaway-qr.component.scss']
})
export class ScanPutawayQrComponent implements OnInit {

  @ViewChild('qr_barcode') qr_barcode:ElementRef;
  ...
  private buildForm() {
    this.validationForm = this._fb.group({
      qr_barcode: [null, [Validators.required]],
  ...
  async onQrEntered(_qr: string) {
    ...
    /* this.model_scan.wc_code = this._actRoute.snapshot.params.wc_code;
     ...
     //console.log( this.model_scan.doc_no + "|" + this.model_scan.doc_code + "|" + this.model_scan.doc_date + "|" + this.model_scan.wc_code + "|" + this.model_scan.fr_wh_code + "|" + this.model_scan.loc_code + "|" + this.model_scan.wh_code + "|" + this.model_scan.user_id) ;

    
     this.datas_scan = await this._putawaySvc.searchPutAwayAdd(this.model_scan);
