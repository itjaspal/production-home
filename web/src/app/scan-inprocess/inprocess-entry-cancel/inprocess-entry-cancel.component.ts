...
import { ProductCancelSearchComponent } from '../product-cancel-search/product-cancel-search.component';
import { ProductSearchComponent } from '../product-search/product-search.component';

@Component({
  selector: 'app-inprocess-entry-cancel',
  templateUrl: './inprocess-entry-cancel.component.html',
  styleUrls: ['./inprocess-entry-cancel.component.scss']
})
export class InprocessEntryCancelComponent implements OnInit {
  ...
  async save() {
    ...
    this.datas = await this._jobInprocessSvc.searchentrycancel(this.searchModel);
  ...
  {
    const dialogRef = this._dialog.open(ProductCancelSearchComponent, {
      maxWidth: '100vw',
      maxHeight: '100vh',
      height: '80%',
      width: '80%',
